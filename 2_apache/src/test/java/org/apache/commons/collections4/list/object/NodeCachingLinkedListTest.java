package org.apache.commons.collections4.list.object;
...
public class NodeCachingLinkedListTest { 
	...
	//Change with sedl 
	    ...
	    static void initAll() {
	    	...
	    	scope = Config.scope;
	    	pathFile = "beapi-tests/serialize/org.apache.commons.collections4.list.object.NodeCachingLinkedList/"+scope+"/objects.ser";
	...
	public void get_last_test(NodeCachingLinkedList list) {	
		...
		Integer b = (Integer)list.getLast();
		assertTrue(list.repOK());
		assertTrue(list.contains(b));
