...
public class TreeMapTest { 
    ...
    static void initAll() {
    	...
    	scope = Config.scope;
    	pathFile = "serialize/java2.util2.treemap.TreeMap/"+Config.scope+"/randoop.ser";
    	literals = Config.literals;
    }

	@AfterAll
    static void afterAll() {
		File dir = new File("../scripts/reportRandoopObj/java2.util2.treemap.TreeMap/"+Config.scope);
		 if (! dir.exists()){
		        dir.mkdir();            
		 }
